<h1 align="left">Pranav Khalate <img align="center" src="https://media.giphy.com/media/lGhBlBMIN2XsEteTN3/giphy.gif" width="80" alt="Coding GIF"/></h1>

  **`Full Stack Developer`** &nbsp; **`Web Developer`** &nbsp; **`Tech Enthusiast`**


### 🌟 About Me
Pranav Khalate, a passionate Full Stack Developer based in Mumbai, India, dedicated to crafting impactful applications with modern technologies. My journey began on April 2, 2025, driven by a deep curiosity for how technology can solve real-world problems and enhance user experiences, leveraging a diverse set of skills.

I thrive on bringing ideas to life, from conceptual design to deployment, always seeking to build robust, scalable, and intuitive solutions. My toolkit spans across various modern frameworks and languages, allowing me to tackle complex challenges and contribute effectively to projects that push the boundaries of innovation and leave a lasting positive impact.

<!-- If the user provided custom social/contact badges in the options -->
<div align="left" style="display: flex; flex-wrap: wrap;">
  <a href="https://github.com/FrostByte-49?tab=repositories&sort=stargazers" style="text-decoration: none;"><img alt="Total Stars" title="Total Stars" src="https://img.shields.io/github/stars/FrostByte-49?style=for-the-badge&color=FF69B4&label=Stars&logo=github&logoColor=white&labelColor=E91E63" /></a>&nbsp;
  <a href="https://github.com/FrostByte-49?tab=followers" style="text-decoration: none;"><img alt="GitHub Followers" title="Followers" src="https://img.shields.io/github/followers/FrostByte-49?style=for-the-badge&color=BA68C8&label=Followers&logo=github&logoColor=white&labelColor=8E24AA" /></a>&nbsp;
  <a href="https://github.com/FrostByte-49" style="text-decoration: none;"><img alt="Profile Views" title="Views" src="https://komarev.com/ghpvc/?username=FrostByte-49&color=FF69B4&style=for-the-badge&labelColor=FF69B4&logo=github&logoColor=white&label=Visitors"/></a>
</div>
...
<p align="left">
  <!-- Generate skillicons.dev icons based off the DETECTED TECH STACK -->
  <!-- Format: -->
  <!-- <img -->
  <!--   src="https://skillicons.dev/icons?i=slug1,slug2,slug3&perline=18" -->
  <!--   width="100%" -->
  <!-- /> -->
  <img 
    src="https://skillicons.dev/icons?i=react,javascript,html,css,tailwindcss,sass,figma,nodejs,express,java,cs,cpp,postgresql,mysql,mongodb,redis,sqlite,prisma,gcp,vercel,netlify,firebase,supabase,git,github,reactnative,apple,vscode,vim,bash,typescript,powershell&perline=18"
    width="100%"
  />
</p>
...
### 📊 GitHub Stats
<p align="center"> 
  <img height="180em" width="430" src="https://github-readme-stats-sigma-five.vercel.app/api?username=FrostByte-49&show_icons=true&theme=dracula&include_all_commits=true&count_private=true"/> &nbsp;
  <img height="180em" width="386" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=FrostByte-49&layout=compact&theme=dracula"/> <br>
...
### 📈 Contribution Graph
<p align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=FrostByte-49&theme=dracula" alt="Contribution Graph" />
</p>
...
|---|---|---|---|
| Zener_Diode_Simulation | Design, Simulate & Analyze Zener Diode Circuits With Drag-and-Drop Ease, Real-Time Calculations & Interactive Graphs | 6 ⭐ | [View Repository](https://github.com/FrostByte-49/Zener_Diode_Simulation) |
| FrostByte-49 | GitHub Profile README – A Glimpse Into My Developer Journey | 5 ⭐ | [View Repository](https://github.com/FrostByte-49/FrostByte-49) |
| MindEaze | Minimalist Offline Mood Tracker & Wellness Journal App For Daily Mental Clarity & Self-Care | 5 ⭐ | [View Repository](https://github.com/FrostByte-49/MindEaze) |
| Portfolio_Templates | Explore Ready-to-Use Portfolio Templates | 3 ⭐ | [View Repository](https://github.com/FrostByte-49/Portfolio_Templates) |
| Mini_Games | A Collection Of Web-Based Mini Games – Test Logic, Speed, Debugging & Memory Skills | 3 ⭐ | [View Repository](https://github.com/FrostByte-49/Mini_Games) |

##

### 🏆 GitHub Trophies
<p align="center">
  <img src="https://github-trophies.vercel.app/?username=FrostByte-49&theme=dracula&row=1&column=6" />
</p>
...
<div align="left">
  <a href="https://www.linkedin.com/in/pranav-kh" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a> &nbsp;<a href="https://github.com/FrostByte-49" target="_blank"><img src="https://img.shields.io/badge/-GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/></a> &nbsp;<a href="https://pranavkh.vercel.app/" target="_blank"><img src="https://img.shields.io/badge/-Portfolio-3a86ff?style=for-the-badge&logo=portfolio&logoColor=white" alt="Portfolio"/></a> &nbsp;<a href="mailto:pranav.kh25@gmail.com" target="_blank"><img src="https://img.shields.io/badge/-Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Gmail"/></a> &nbsp;
</div>
...
<div align="right">
  <a href="https://trywharf.vercel.app/" target="_blank" style="text-decoration:none;display:inline-block;">
    <div style="display:inline-flex;align-items:center;gap:10px;padding:4px 12px;border:2px solid #eaeaea;border-radius:20px;background:#ffffff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;">
      <div style="width:32px;height:32px;min-width:32px;border:1px solid #444444;border-radius:999px;display:flex;align-items:center;justify-content:center;background:#ffffff;">
        <img src="https://res.cloudinary.com/dhn92qb61/image/upload/v1777107144/Wharf_Logo-Photoroom_upscaled_tgvwm2.webp" alt="Wharf" style="width:32px;height:32px;object-fit:contain;" />
      </div>
      <div style="width:1px;height:18px;background:#444444;"></div>
      <span style="font-size:12px;color:#0f172a;font-weight:600;">Documented By Wharf</span>
    </div>
  </a>
</div>
...
<div align="left">
  ...
  <a href="https://pranavkhalate.netlify.app/" target="_blank"><img src="https://img.shields.io/badge/-Portfolio-3a86ff?style=for-the-badge&logo=vercel&logoColor=white" alt="Portfolio"/></a> &nbsp;
