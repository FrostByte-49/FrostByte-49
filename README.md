...
### ⚙ Languages & Technologies <br><br>
<p align="left">
  <img src="https://skillicons.dev/icons?i=react,typescript,javascript,html,css,tailwindcss,sass,figma,nodejs,express,java,cs,cpp,postgresql,mysql,mongodb,redis,sqlite,prisma,gcp,vercel,netlify,firebase,supabase,git,github,react,android,apple,vscode&perline=15" alt="React, TypeScript, JavaScript, HTML5, CSS3, Tailwind CSS, Sass, Figma, Node.js, Express, Java, C#, C++, PostgreSQL, MySQL, MongoDB, Redis, SQLite, Prisma, GCP, Vercel, Netlify, Firebase, Supabase, Git, GitHub, React Native, Android, iOS, VS Code" />
</p>
...
<p align="left">
  <img 
    src="https://skillicons.dev/icons?i=react,typescript,javascript,html,css,tailwindcss,sass,figma,nodejs,express,java,cs,cpp,postgresql,mysql,mongodb,redis,sqlite,prisma,gcp,vercel,netlify,firebase,supabase,git,github,react,android,apple,vscode&perline=15"
